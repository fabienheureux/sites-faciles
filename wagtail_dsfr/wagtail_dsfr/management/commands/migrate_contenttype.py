"""
Django management command to migrate ContentType app labels from Sites Faciles to wagtail_dsfr.

This command updates ContentType records in the database when migrating from a Sites Faciles
website to the packaged version of wagtail_dsfr.
...
class Command(BaseCommand):
    help = "Migrate ContentType app labels from Sites Faciles to wagtail_dsfr"

    # Mapping of old app labels to new app labels
    APP_LABEL_MAPPING = {
        "blog": "wagtail_dsfr_blog",
        "events": "wagtail_dsfr_events",
        "forms": "wagtail_dsfr_forms",
        "content_manager": "wagtail_dsfr_content_manager",
        "config": "wagtail_dsfr_config",
    }
    ...
    def handle(self, *args, **options):
        ...
        if missing_mappings:
            ...
            self.stdout.write(
                self.style.WARNING(
                    "\nPlease ensure all wagtail_dsfr apps are in INSTALLED_APPS "
