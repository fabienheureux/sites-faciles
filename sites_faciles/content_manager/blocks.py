...
class HeroImageAndTextBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "minus"
        template = "sites_faciles_content_manager/heros/hero_image_text.html"
...
class HeroWideImageAndTextBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "minus"
        template = "sites_faciles_content_manager/heros/hero_wide_image_text.html"
...
class HeroBackgroundImageBlock(blocks.StructBlock):
    ...
    class Meta:
        icon = "minus"
        template = "sites_faciles_content_manager/heros/hero_background_image_text.html"
...
class OldHero(blocks.StructBlock):
    ...
    class Meta:
        ...
        template = "sites_faciles_content_manager/heros/old_hero.html"
