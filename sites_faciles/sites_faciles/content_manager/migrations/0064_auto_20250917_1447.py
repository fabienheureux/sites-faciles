...
def migrate_old_hero_in_new_streamfield_hero(apps, schema_editor):
    ...
    CatalogIndexPage = apps.get_model("sites_faciles_content_manager", "CatalogIndexPage")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("sites_faciles_content_manager", "0063_catalogindexpage_hero_contentpage_hero_and_more"),
    ]
